...
permission_restriction_link = Table('permission_restriction', cbpos.database.Base.metadata,
    Column('permission_id', Integer, ForeignKey('permissions.id'), primary_key=True),
    Column('restriction_id', Integer, ForeignKey('menurestrictions.id'), primary_key=True)
)

class MenuRestriction(cbpos.database.Base, common.Item):
...
class Permission(cbpos.database.Base, common.Item):
