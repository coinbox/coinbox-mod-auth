...
from cbpos.mod.auth.models.role import Role, role_permission_link
from cbpos.mod.auth.models.permission import Permission, MenuRestriction, permission_restriction_link
